...
//     console.log('a=b='+a);
// }
// console.log('请输入两个数，判断两个数，并输出最大值');
// console.log('请输入a:');
// let a=scanf('%d');          
// console.log('请输入b:');
// let b=scanf('%d');
...
//     console.log('4--退出坐标系统');
//     // console.log("arr",arr)
//     // console.log("scanf",scanf)
//     let con=scanf('%d');
//     // console.log("con",con)
//     // console.log("arr",arr)
//     if(con===1){
...
let arr=[];
while(1){
    console.log('1-添加一个学生的学科成绩');//打印出来
    console.log('2-显示全部学生的学科成绩');
    console.log('3-删除一个学生的学科成绩');
    console.log('4-退出');
    let con=scanf("%d"); //随便输入一个数
    if (con===1) {
        console.log('1-添加一个学生的学科成绩');
        console.log('请输入姓名');
        let name=scanf('%s');
        console.log('请输入英语成绩');
        let yingyu=scanf('%d');
        ...
        arr.push('student'); //在arr数组中添加一组数据
        console.log('成绩添加成功');
        scanf('%d');
    }
    if (con===2) {
